<div class="drop">
	<ul class="drop_menu">
		<li><a href="javascript:void(0);">1 - <?php _e('Positions', BANNERS_PREF); ?> &raquo;</a>
			<ul>
		...
		<li><a href="javascript:void(0);">2 - <?php _e('Advertisers', BANNERS_PREF); ?> &raquo;</a>
			<ul>
		...
		<li><a href="javascript:void(0);">3 - <?php _e('Banners', BANNERS_PREF); ?> &raquo;</a>
			<ul>
				<li><a href="<?php echo osc_route_admin_url('banners-admin-set'); ?>"><?php _e('Add new banner', BANNERS_PREF); ?></a></li>
		...
		<li><a href="<?php echo osc_route_admin_url('banners-admin-settings'); ?>"><?php _e('Settings'); ?></a></li>
	</ul>
</div>
